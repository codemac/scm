...
(define-public config-debug #f)
(define-public config-package-name "GNU Mcron")
(define-public config-package-version "1.0.8")
(define-public config-package-string "GNU Mcron 1.0.8")
(define-public config-package-bugreport "bug-mcron@gnu.org")
(define-public config-package-url "http://www.gnu.org/software/mcron/")
(define-public config-sendmail "/bin/mail -d ")
